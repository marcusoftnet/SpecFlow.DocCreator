...
namespace Tests.TestData._01TestRunner
{
    ...
    [NUnit.Framework.DescriptionAttribute("In order to show that the test runner is just for the autogenerated stuff in Spec" +
        "Flow\nAs a SpecFlow evanglist\nI want to be able to call my steps in the same mann" +
        "er inspite of the testrunner configured")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "The test runner is not (very) important", "In order to show that the test runner is just for the autogenerated stuff in Spec" +
                    "Flow\nAs a SpecFlow evanglist\nI want to be able to call my steps in the same mann" +
                    "er inspite of the testrunner configured", ProgrammingLanguage.CSharp, ((string[])(null)));
