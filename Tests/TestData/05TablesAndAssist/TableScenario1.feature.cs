...
namespace Tests.TestData._05TablesAndAssist
{
    ...
    [NUnit.Framework.DescriptionAttribute("In order to show how to use tables\nAs a SpecFlow evanglist\nI want to write some s" +
        "imple scenarios that uses tables tables")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Showing table usage", "In order to show how to use tables\nAs a SpecFlow evanglist\nI want to write some s" +
                    "imple scenarios that uses tables tables", ProgrammingLanguage.CSharp, ((string[])(null)));
