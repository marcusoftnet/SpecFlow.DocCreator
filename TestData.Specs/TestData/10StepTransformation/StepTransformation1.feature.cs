...
namespace Tests.TestData._10StepTransformation
{
    ...
    [NUnit.Framework.DescriptionAttribute("In order to reduce the amount of code and repetitive tasks in my steps\r\nAs a Spec" +
